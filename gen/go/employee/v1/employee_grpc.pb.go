...
const (
	...
	EmployeeService_GetEmployeesByIDs_FullMethodName = "/employee.v1.EmployeeService/GetEmployeesByIDs"
...
type EmployeeServiceClient interface {
	...
	GetEmployeesByIDs(ctx context.Context, in *GetEmployeesByIDsRequest, opts ...grpc.CallOption) (*GetEmployeesByIDsResponse, error)
...
func (c *employeeServiceClient) GetEmployeesByIDs(ctx context.Context, in *GetEmployeesByIDsRequest, opts ...grpc.CallOption) (*GetEmployeesByIDsResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetEmployeesByIDsResponse)
	err := c.cc.Invoke(ctx, EmployeeService_GetEmployeesByIDs_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type EmployeeServiceServer interface {
	...
	GetEmployeesByIDs(context.Context, *GetEmployeesByIDsRequest) (*GetEmployeesByIDsResponse, error)
...
func (UnimplementedEmployeeServiceServer) GetEmployeesByIDs(context.Context, *GetEmployeesByIDsRequest) (*GetEmployeesByIDsResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetEmployeesByIDs not implemented")
}
...
func _EmployeeService_GetEmployeesByIDs_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetEmployeesByIDsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(EmployeeServiceServer).GetEmployeesByIDs(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: EmployeeService_GetEmployeesByIDs_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(EmployeeServiceServer).GetEmployeesByIDs(ctx, req.(*GetEmployeesByIDsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var EmployeeService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetEmployeesByIDs",
			Handler:    _EmployeeService_GetEmployeesByIDs_Handler,
		},
		{
